<x-l-layout::form :action="route('app.manual.connect.store')" >
    ...
    @if((int) $prop->getProp('import_disk') == 0)
        ...
        <x-l::form-input-error :messages="$errors->get('manualConnectPath')"/>
        <x-l::form-input name="manualConnectPath" type="text" :value="old('manualConnectPath', $prop->getProp('self_path'))"/>
